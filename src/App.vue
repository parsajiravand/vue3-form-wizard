    ...
    return () =>
      h('div', [
        ...
        h('label', [
          ...
          h(
            'select',
            { value: props.data.plan, onChange: (e: Event) => props.updateData({ plan: (e.target as HTMLSelectElement).value }) },
            [h('option', { value: 'basic' }, 'Basic'), h('option', { value: 'premium' }, 'Premium')],
          ),
        ]),
      ])
  },
    ...
    <main class="main">
      ...
      <div v-show="currentSample === '2'" class="sample">
        <form-wizard title="With Icons" color="#9b59b6" @on-complete="handleComplete('2')">
          <tab-content title="Personal" icon="fa fa-user"
            ><div>
              <h2>Personal</h2>
              <p>Your details.</p>
            </div></tab-content
          >
          <tab-content title="Details" icon="fa fa-file"
            ><div>
              <h2>Details</h2>
              <p>More info.</p>
            </div></tab-content
      ...
      <div v-show="currentSample === '3'" class="sample">
        ...
        >
          <tab-content title="One"
            ><div><p>Step one.</p></div></tab-content
          >
          <tab-content title="Two"
            ><div><p>Step two.</p></div></tab-content
          >
          <tab-content title="Three"
            ><div><p>Step three.</p></div></tab-content
          >
        </form-wizard>
      </div>
      ...
      <div v-show="currentSample === '4'" class="sample vertical-sample">
        <form-wizard title="Vertical Layout" layout="vertical" color="#1abc9c" @on-complete="handleComplete('4')">
          <tab-content title="Step 1"
            ><div><p>Vertical step 1.</p></div></tab-content
          >
          <tab-content title="Step 2"
            ><div><p>Vertical step 2.</p></div></tab-content
          >
          <tab-content title="Step 3"
            ><div><p>Vertical step 3.</p></div></tab-content
          >
        </form-wizard>
      </div>
      ...
      <div v-show="currentSample === '5'" class="sample">
        <form-wizard title="Small Steps" step-size="sm" color="#34495e" @on-complete="handleComplete('5')">
          <tab-content title="S1"
            ><div><p>Small steps.</p></div></tab-content
          >
          <tab-content title="S2"
            ><div><p>Compact.</p></div></tab-content
          >
          <tab-content title="S3"
            ><div><p>Done.</p></div></tab-content
          >
        </form-wizard>
      </div>
      ...
      <div v-show="currentSample === '6'" class="sample">
        <form-wizard title="Square Shape" shape="square" color="#8e44ad" @on-complete="handleComplete('6')">
          <tab-content title="A"
            ><div><p>Square steps.</p></div></tab-content
          >
          <tab-content title="B"
            ><div><p>Step B.</p></div></tab-content
          >
          <tab-content title="C"
            ><div><p>Step C.</p></div></tab-content
          >
        </form-wizard>
      </div>
      ...
      <div v-show="currentSample === '7'" class="sample">
        <form-wizard title="Validation" color="#c0392b" @on-complete="handleComplete('7')">
          ...
          <tab-content title="Step 2 (Blocked)" :before-change="() => false">
            <div>
              <h2>Step 2</h2>
              <p>beforeChange returns false – you cannot leave this step.</p>
            </div>
          </tab-content>
          <tab-content title="Step 3"
            ><div>
      ...
      <div v-show="currentSample === '8'" class="sample">
        <form-wizard title="Lazy Content" color="#16a085" @on-complete="handleComplete('8')">
          <tab-content title="Eager" lazy
            ><div><p>Rendered when step is active.</p></div></tab-content
          >
          <tab-content title="Lazy 2" lazy
            ><div><p>Lazy step 2.</p></div></tab-content
          >
          <tab-content title="Lazy 3" lazy
            ><div><p>Lazy step 3.</p></div></tab-content
          >
        </form-wizard>
      </div>
      ...
      <div v-show="currentSample === '9'" class="sample">
        <form-wizard title="Default Title" color="#2980b9" @on-complete="handleComplete('9')">
          ...
          <tab-content title="Step 1"
            ><div><p>Step 1.</p></div></tab-content
          >
          <tab-content title="Step 2"
            ><div><p>Step 2.</p></div></tab-content
          >
        </form-wizard>
      </div>
      ...
      <div v-show="currentSample === '10'" class="sample">
        <form-wizard title="Blue Theme" color="#2980b9" error-color="#c0392b" @on-complete="handleComplete('10')">
          <tab-content title="Blue"
            ><div><p>Custom color theme.</p></div></tab-content
          >
          <tab-content title="Step 2"
            ><div><p>Step 2.</p></div></tab-content
          >
      ...
      <div v-show="currentSample === '11'" class="sample">
        <form-wizard title="Custom Footer" color="#27ae60" @on-complete="handleComplete('11')">
          ...
          <tab-content title="1"
            ><div><p>Custom footer buttons.</p></div></tab-content
          >
          <tab-content title="2"
            ><div><p>Step 2.</p></div></tab-content
          >
      ...
      <div v-show="currentSample === '12'" class="sample">
        <form-wizard title="Start at Step 2" :start-index="1" color="#8e44ad" @on-complete="handleComplete('12')">
          <tab-content title="Step 1"
            ><div><p>Step 1 (skipped on load).</p></div></tab-content
          >
          <tab-content title="Step 2"
            ><div>
              <h2>Step 2</h2>
          ...
          >
          <tab-content title="Step 3"
            ><div><p>Step 3.</p></div></tab-content
          >
        </form-wizard>
      </div>
      ...
      <div v-show="currentSample === '13'" class="sample">
        <form-wizard title="No Back Button" :disable-back="true" color="#d35400" @on-complete="handleComplete('13')">
          <tab-content title="Step 1"
            ><div><p>Back button is hidden.</p></div></tab-content
          >
          <tab-content title="Step 2"
            ><div><p>Step 2.</p></div></tab-content
          >
